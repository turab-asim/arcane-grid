...
namespace DTT.InfiniteScroll.Editor
{
    ...
    internal class InfiniteScrollSerializedPropertyCache : SerializedPropertyCache
    {
        ...
        /// </summary>
        public SerializedProperty ElementWrappedProperty => base["ElementWrapped"];
        
        /// <summary>
        /// Serialized property for the element partially entered viewport event property.
        /// </summary>
        public SerializedProperty ElementPartiallyEnteredViewportProperty => base["ElementPartiallyEnteredViewport"];
        
        /// <summary>
        /// Serialized property for the element partially exited viewport event property.
        /// </summary>
        public SerializedProperty ElementPartiallyExitsViewportProperty => base["ElementPartiallyExitsViewport"];
        
        /// <summary>
        /// Serialized property for the element fully entered viewport event property.
        /// </summary>
        public SerializedProperty ElementFullyEnteredViewportProperty => base["ElementFullyEnteredViewport"];
        
        /// <summary>
        /// Serialized property for the element fully exited viewport event property.
        /// </summary>
        public SerializedProperty ElementFullyExitsViewportProperty => base["ElementFullyExitsViewport"];
        
        /// <summary>
        /// Serialized property for the use snapping property.
        /// </summary>
        public SerializedProperty UseSnapping => base["_useSnapping"];
        
        /// <summary>
        /// Serialized property for the snap strength property.
        /// </summary>
        public SerializedProperty SnapStrength => base["_snapStrength"];
        
        /// <summary>
        /// Serialized property for disabling infinite scroll property.
        /// </summary>
        public SerializedProperty DisableInfiniteScroll => base["_disableInfiniteScroll"];
